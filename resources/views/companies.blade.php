...
<body>
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Rizki Company Server 1</a>
                  ...
                  <thead>
                    ...
                    <tbody> 
                      ...
                      <tr>
                          ...
                          <td>
                             <a href="javascript:void(0)" class="btn btn-warning edit" data-id="{{ $Company->id }}">Edit</a>
                             <a href="javascript:void(0)" class="btn btn-danger delete" data-id="{{ $Company->id }}">Delete</a>
                          </td>
                      </tr>
                      @endforeach
                    </tbody>
